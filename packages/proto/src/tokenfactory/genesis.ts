...
export interface GenesisStateProtoMsg {
  typeUrl: "/kiichain.kiichain3.tokenfactory.GenesisState";
  value: Uint8Array;
}
/** GenesisState defines the tokenfactory module's genesis state. */
...
export interface GenesisStateAminoMsg {
  type: "/kiichain.kiichain3.tokenfactory.GenesisState";
...
export interface GenesisDenomProtoMsg {
  typeUrl: "/kiichain.kiichain3.tokenfactory.GenesisDenom";
  value: Uint8Array;
}
/**
 * GenesisDenom defines a tokenfactory denom that is defined within genesis
...
export interface GenesisDenomAminoMsg {
  type: "/kiichain.kiichain3.tokenfactory.GenesisDenom";
