...
export class MsgClientImpl implements Msg {
  ...
  addRateLimit(request: MsgAddRateLimit): Promise<MsgAddRateLimitResponse> {
    ...
    return promise.then((data) =>
      MsgAddRateLimitResponse.decode(new BinaryReader(data))
    );
  }
  updateRateLimit(
    request: MsgUpdateRateLimit
    ...
    return promise.then((data) =>
      MsgUpdateRateLimitResponse.decode(new BinaryReader(data))
    );
  }
  removeRateLimit(
    request: MsgRemoveRateLimit
    ...
    return promise.then((data) =>
      MsgRemoveRateLimitResponse.decode(new BinaryReader(data))
    );
  }
  resetRateLimit(
    request: MsgResetRateLimit
    ...
    return promise.then((data) =>
      MsgResetRateLimitResponse.decode(new BinaryReader(data))
    );
  }
}
