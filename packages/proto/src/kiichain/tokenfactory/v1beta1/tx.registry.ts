...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/kiichain.tokenfactory.v1beta1.MsgCreateDenom", MsgCreateDenom], ["/kiichain.tokenfactory.v1beta1.MsgMint", MsgMint], ["/kiichain.tokenfactory.v1beta1.MsgBurn", MsgBurn], ["/kiichain.tokenfactory.v1beta1.MsgChangeAdmin", MsgChangeAdmin], ["/kiichain.tokenfactory.v1beta1.MsgSetDenomMetadata", MsgSetDenomMetadata], ["/kiichain.tokenfactory.v1beta1.MsgForceTransfer", MsgForceTransfer], ["/kiichain.tokenfactory.v1beta1.MsgUpdateParams", MsgUpdateParams]];
