 ...
 */
export const STAKING_PRECOMPILE_ADDRESS: `0x${string}` = '0x0000000000000000000000000000000000000800';
        ...
        "components": [
          ...
          { "internalType": "string", "name": "validatorAddress", "type": "string" },
          {
            "components": [
              ...
              { "internalType": "int64", "name": "unbondingOnHoldRefCount", "type": "int64" }
            ],
