 ...
 * This contract gets associated KiiChain and EVM addresses.
...
export const ADDRESS_PRECOMPILE_ABI = [
	...
	},
	{
		...
		name: 'associate',
		outputs: [{ internalType: 'string', name: 'kiiAddr', type: 'string' }, { internalType: 'address', name: 'evmAddr', type: 'address' }],
