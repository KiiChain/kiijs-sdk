 ...
 * @example
 * ```tsx
 * import { getIbcPrecompileEthersV6Contract } from '@devkiiglobal/kiijs-evm/ethers';
 ...
 *
 * const bool = await ibcPrecompileContract.transfer(cosmosAddress, 'transfer', 'channel-0', 'ukii', 100, 1n, 1n, 1n, 'memo');
