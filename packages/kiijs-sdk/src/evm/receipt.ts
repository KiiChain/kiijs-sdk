...
export interface LogProtoMsg {
  typeUrl: "/kiichain.kiichain3.evm.Log";
  value: Uint8Array;
}
...
export interface LogAminoMsg {
  type: "/kiichain.kiichain3.evm.Log";
  value: LogAmino;
}
...
export interface ReceiptProtoMsg {
  typeUrl: "/kiichain.kiichain3.evm.Receipt";
  value: Uint8Array;
}
...
export interface ReceiptAminoMsg {
  type: "/kiichain.kiichain3.evm.Receipt";
  value: ReceiptAmino;
}
...
export const Log = {
  ...
  fromAmino(object: LogAmino): Log {
    ...
    if (object.synthetic !== undefined && object.synthetic !== null) {
      message.synthetic = object.synthetic;
    }
    return message;
  },
  toAmino(message: Log): LogAmino {
    ...
    obj.synthetic = message.synthetic === false ? undefined : message.synthetic;
    return obj;
  },
...
export const Receipt = {
  ...
  fromPartial(object: Partial<Receipt>): Receipt {
    ...
    message.effectiveGasPrice = object.effectiveGasPrice !== undefined && object.effectiveGasPrice !== null ? BigInt(object.effectiveGasPrice.toString()) : BigInt(0);
